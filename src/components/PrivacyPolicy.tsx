...
import { ShieldCheck, Lock, Mail, Phone, Calendar, Search, MapPin, CheckCircle, FileText, ChevronRight, Eye, Server, Database, Globe, UserCheck, ArrowLeft } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-6">
          <a
            ...
            className="inline-flex items-center gap-2 text-xs font-mono font-semibold text-slate-400 hover:text-emerald-400 bg-slate-900 border border-slate-800 hover:border-slate-700 px-3.5 py-2 rounded-xl transition-all cursor-pointer"
          >

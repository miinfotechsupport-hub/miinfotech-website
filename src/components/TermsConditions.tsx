...
import { ShieldCheck, ArrowUpRight, Scale, Mail, Phone, Calendar, Search, MapPin, CheckCircle, FileText, ChevronRight, ArrowLeft } from "lucide-react";
  ...
  const clauses = [
    {
      ...
      content: "By accessing or using the MIINFOTECH website (https://miinfotech.netlify.app/) or engaging MIINFOTECH for any onsite IT support, computer or laptop repair, CCTV installation, networking solutions, or hardware components, you agree to be bound by these Terms of Service. These terms constitute a legally binding agreement between the client (referred to as \"Customer\", \"User\", \"you\", or \"your\") and MIINFOTECH (referred to as \"MIInfotech\", \"we\", \"us\", or \"our\"). If you do not agree with any part of these terms, you should discontinue using our website and notify us immediately prior to the commencement of any onsite services."
    },
    {
      id: 2,
      title: "2. Business Information & SAB Model",
      content: "MIINFOTECH is a professional, registered Service-Area Business (SAB) specializing in doorstep onsite IT infrastructure, computing, and security solutions. Founded and operated by Mohammed Ishtiaqh, we serve residential, retail, SME, and institutional customers in Hassan City, Karnataka, India, and surrounding outskirts. We operate strictly as an onsite mobile service provider, meaning we do not maintain a retail walk-in storefront; all hardware diagnostics, installations, and repairs are carried out at your designated doorstep or physical site. Standard business operating hours are from 9:30 AM to 8:00 PM, Monday through Saturday, and 10:00 AM to 3:00 PM on Sunday."
    },
    {
      id: 3,
      title: "3. Website Usage & Permitted Conduct",
      content: "You agree to use this website solely for lawful purposes and in accordance with these Terms of Service. You agree not to: \n• Use the website in any manner that could disable, overburden, damage, or impair website functionality.\n• Attempt to gain unauthorized access to any administrative accounts, computer systems, or networks connected to our servers or database.\n• Introduce any viruses, trojan horses, worms, or other technologically harmful materials.\n• Use any automated bot, scraper, or spider to harvest content, images, or customer review data without prior written permission."
    },
    {
      id: 4,
      title: "4. Services & Service Enquiries",
      content: "Our website allows users to explore service descriptions, estimate onsite costs using our interactive calculators, and submit service booking enquiries. Submitting an enquiry or cost estimation through the website does not create a binding service contract until MIINFOTECH reviews your requirements, confirms availability, and formally schedules an onsite appointment. We reserve the right to decline or reschedule service bookings based on technician availability, severe weather, or site location constraints."
    },
    {
      id: 5,
      title: "5. Product & Service Information",
    ...
    },
    {
      ...
      content: "Payments for all onsite diagnostics, basic desktop repairs, or general troubleshooting are due immediately upon the completion of the physical service call. We accept payments through physical Cash, major UPI channels (Google Pay, PhonePe, Paytm), and instant Bank Transfers. We do not process online credit card payments or store customer card numbers on this website. For extensive system deployments, complex structured LAN cabling, or CCTV security projects, the client must pay an advance deposit of 50% of the total estimated invoice value before physical materials are dispatched or work begins. The remaining 50% balance is strictly due immediately upon final physical installation and testing."
    },
    {
      id: 9,
      title: "9. Goods Once Sold Policy",
    ...
    {
      id: 12,
      title: "12. Electrical Point & Site Readiness",
    ...
    {
      id: 13,
      title: "13. Additional Materials & Extra Charges",
    ...
    {
      id: 14,
      title: "14. Service Visit Charges",
    ...
    {
      id: 16,
      title: "16. Manufacturer Warranty",
    ...
    {
      id: 17,
      title: "17. Warranty Claim Processing",
    ...
    {
      id: 18,
      title: "18. Items Not Covered Under Warranty",
    ...
    {
      id: 19,
      title: "19. No Warranty on Accessories",
    ...
    {
      id: 21,
      title: "21. Data Backup & Loss Disclaimer",
    ...
    {
      id: 22,
      title: "22. Annual Maintenance Contract (AMC) Terms",
    ...
    {
      id: 23,
      title: "23. Cancellation & Rescheduling Policy",
    ...
    },
    {
      ...
      content: "To the maximum extent permitted by applicable Indian law, the total cumulative liability of MIInfotech and its founder Mohammed Ishtiaqh for any direct claims, losses, service damages, or performance failures arising out of a specific service call or use of this website, shall never exceed the actual amount paid by the customer to MIInfotech for that specific service call. We are not liable for secondary business interruption, loss of profits, or data leaks."
    },
    {
      id: 25,
      title: "25. Third-Party Products & External Links",
      content: "Our website may contain hyperlinks to third-party web destinations, such as WhatsApp Web, Google Maps, or external manufacturer websites. These external links are provided purely for user convenience. MIINFOTECH does not endorse, monitor, or exercise control over the content, privacy policies, or operational practices of any third-party websites. Additionally, MIINFOTECH carries zero product liability for inherent manufacturing design flaws or firmware updates announced by original equipment manufacturers (OEMs)."
    },
    {
      id: 26,
    ...
    {
      id: 27,
      title: "27. Website Availability & Uptime",
      content: "While we strive to ensure that https://miinfotech.netlify.app/ remains available 24/7, we do not guarantee uninterrupted or error-free access. We may temporarily suspend, restrict, or modify website access for maintenance, updates, or technical upgrades without prior notice."
    },
    {
      id: 28,
      title: "28. Privacy & Confidentiality",
      content: "MIInfotech respects customer privacy and digital integrity. During physical repairs, data transfers, or DVR camera sync tasks, our technicians only access data areas strictly necessary to complete the service. We do not inspect, copy, or distribute your private databases, personal photo archives, email records, or surveillance videos. Please refer to our Privacy Policy (/privacy-policy) for detailed information on our data practices."
    },
    {
      id: 29,
      title: "29. Governing Law & Jurisdiction",
      content: "These Terms of Service and any commercial engagements shall be governed, interpreted, and enforced in compliance with the laws of the Republic of India and the State of Karnataka. Any legal dispute, claim, or litigation arising between the Customer and MIINFOTECH shall be subject exclusively to the territorial jurisdiction of the competent courts located in Hassan, Karnataka, India."
    },
    {
      id: 30,
      title: "30. Changes to Terms of Service",
      content: "MIINFOTECH reserves the complete right, at our sole discretion, to modify, update, append, or replace these Terms of Service at any time. Any changes will be posted immediately on this page with an updated 'Effective Date'. Your continued use of the website or engagement for onsite services following updates constitutes complete acceptance of the revised terms."
    },
    {
      id: 31,
      title: "31. Contact Information",
      content: "If you have any questions, require official clarifications, or want to discuss any specific clause in these terms, please contact MIINFOTECH directly: \n\n• Founder & Proprietor: Mohammed Ishtiaqh \n• Primary Service Phone / WhatsApp: +91 99647 61624 \n• Official Email: miinfotech.support@gmail.com \n• Operating Location: Hassan City & Outskirts, Karnataka 573201, India \n• Service Model: Doorstep Onsite Service-Area Business (SAB)"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-6">
          <a
            ...
            className="inline-flex items-center gap-2 text-xs font-mono font-semibold text-slate-400 hover:text-blue-400 bg-slate-900 border border-slate-800 hover:border-slate-700 px-3.5 py-2 rounded-xl transition-all cursor-pointer"
          >
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-2 max-w-2xl leading-relaxed">
                Please review these professional Terms of Service and operating policies. These clauses outline website usage rules, service bookings, warranty guidelines, customer responsibilities, and payment procedures for MIInfotech in Hassan, Karnataka.
              </p>
            </div>
